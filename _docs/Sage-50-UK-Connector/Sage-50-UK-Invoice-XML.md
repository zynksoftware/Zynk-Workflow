...
| --- | --- | --- | --- | --- | --- | --- |
| Product Code | Sku | PROD001 | string | 30 | | Required when importing the following InvoiceType: <ul><li>ProductInvoice</li><li>item2</li></ul>  *ProductInvoice*    *ProductCredit*  *ProductProforma*  *ProductQuotation*|
