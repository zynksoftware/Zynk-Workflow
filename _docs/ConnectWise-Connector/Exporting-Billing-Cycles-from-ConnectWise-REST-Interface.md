---
slug: exporting-billing-cycles-from-connectwise-rest-interface
title: Exporting Billing Cycles from ConnectWise REST Interface
---
This task will export billing cycles from ConnectWise in an XML format. The results can be filtered if required. See below for a sample output file.
...
_Required_  
When the 'Export Modified, New or All Records' setting is set to 'New', only billing cycles created after this date will be exported. This date will update automatically each time the task runs, to ensure only new billing cycles are exported each time.

### Export Settings > Date Modified
_Required_  
When the 'Export Modified, New or All Records' setting is set to 'Modified', only billing cycles updated after this date will be downloaded. This date will update automatically each time the task runs, to ensure only modified billing cycles are exported each time.
...
### Output File
_Required_  
The name of the file to export the billing cycles to.
...
<BillingCycles xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <BillingCycle>
    <id>1</id>
    <externalId />
    <_info>
      <dateEntered>2004-07-08T13:58:35Z</dateEntered>
      <enteredBy>CONVERSION</enteredBy>
      <lastUpdated>2004-07-08T13:58:35Z</lastUpdated>
      <updatedBy>zadmin</updatedBy>
    </_info>
    <identifier>B</identifier>
    <name>Bi-Monthly</name>
    <defaultFlag>false</defaultFlag>
    <billingOptions>BiMonthly</billingOptions>
  </BillingCycle>
</BillingCycles>
```
