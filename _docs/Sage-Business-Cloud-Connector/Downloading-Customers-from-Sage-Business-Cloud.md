---
slug: downloading-customers-from-sage-business-cloud
title: Downloading Customers from Sage Business Cloud
---
This task will download customer information from your instance of Sage Business Cloud based on your settings. 
...
## Example
A sample output file is shown below. See [Sage Business Cloud Customer XML](sage-business-cloud-customer-xml) for full documentation of the XML format.
```xml
