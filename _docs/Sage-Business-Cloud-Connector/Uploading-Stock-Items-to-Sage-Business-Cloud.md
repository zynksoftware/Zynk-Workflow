---
slug: uploading-stock-items-to-sage-business-cloud
title: Uploading Stock Items to Sage Business Cloud
---
The Import Stock Items task will create new and update existing stock items in Sage Business Cloud. The product data must be provided in the [Sage Business Cloud Stock Item XML](sage-business-cloud-stock-item-xml) format.

See [Uploading Products to Sage Business Cloud](uploading-products-to-sage-business-cloud) for importing non-stock items into Sage Business Cloud.
