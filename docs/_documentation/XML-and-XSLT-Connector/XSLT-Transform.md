...
### Log File
_Optional_  
The file to write any messages generated by the XSLT to. You can generate messages by using the	[xsl:message](http://www.w3schools.com/Xsl/el_message.asp) element in your XSLT. If you don't provide a log file, messages will still be written as debug messages to the logs in Zynk (if debug logging is enabled).
